...
try:
    os.rename(r".minecraft\versions\%s\config\betterquesting\DefaultQuests.json" % PackName,
              r".minecraft\versions\%s\config\betterquesting\DefaultQuests.bak.json" % PackName)
except:
    pass
...
TransResultArr = translate.translate_arr(DataWaitToTransArr)
i = 0
